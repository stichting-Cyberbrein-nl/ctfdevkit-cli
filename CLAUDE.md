# CLAUDE.md — AI Guide for ctfdevkit-cli

This file tells AI assistants (Claude Code, Copilot, Codex, etc.) everything they
need to know about this project and how to work with the owner.
